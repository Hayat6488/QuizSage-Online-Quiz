            ...
            <div className='grid grid-cols-2 gap-4 '>
                {
                    ...
                    quiz.options.map(option => <button className='bg-slate-600 px-2 py-1 text-orange-400 hover:bg-zinc-800 hover:text-yellow-400 break-normal' onClick={() => handleClick(option)}>{option}</button>)
                }
            </div>
